// Netlify function proxying /api/auth/signin to the Spring Boot backend
...
exports.handler = async function (event) {
  ...
  try {
    ...
    const springBootUrl = `${springBootBaseUrl}/api/auth/signin`;
    ...
    console.error('Error forwarding signin request:', error.response || error);
